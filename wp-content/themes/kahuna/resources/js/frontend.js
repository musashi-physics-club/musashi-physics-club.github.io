...
jQuery( document ).ready( function() {
	...
	for (index = 1; index <= kahuna_settings.lpboxratios.length; ++index) {
		jQuery( '.lp-boxes-'+index+' .lp-box-image' ).keepRatio( kahuna_settings.lpboxratios[index-1] );
	}
...
/* Jetpack Portfolio masonry */
function kahuna_portfolio_masonry() {
	if ( ( kahuna_settings.masonry == 1 ) && ( typeof jQuery.fn.masonry !== 'undefined' ) ) {
...
/* Portfolio filtering */
function kahuna_portfolio_filter() {
